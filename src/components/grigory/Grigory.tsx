...
export const Grigory: React.FC = async () => {
  ...
  return (
    <div>
      ...
      <section
        aria-labelledby="film-production-showcase"
        className="max-w-[700px] w-full p-6 rounded-2xl bg-gradient-to-br from-fuchsia-500 via-amber-300 to-cyan-400 shadow-lg"
      >

        <h2
          id="film-production-showcase"
          className="m-0 text-[70px] leading-80px] break-words bg-gradient-to-r from-fuchsia-700 via-amber-500 to-cyan-500 bg-clip-text text-transparent drop-shadow"
        >
          Professional Audio Post-production for Film
        </h2>
        <p className="mt-1 text-[0.95rem] font-medium text-pink-600">
          Here you can see examples of my audio post-production done in pro-tools and final cut pro. Editing Mixing, Location Sound and noise removal using RX by Izotope. 
        </p>
        <div className="video-wrapper">
          <iframe title="vimeo-player" src="https://player.vimeo.com/video/524933864?h=1ac4fd9fb4" width="640" height="360" frameBorder="0" referrerPolicy="strict-origin-when-cross-origin" allow="autoplay; fullscreen; picture-in-picture; clipboard-write; encrypted-media; web-share"   allowFullScreen></iframe>
        </div>
      </section>
    </div>
